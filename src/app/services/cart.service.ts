...
export class CartService {
  ...
  async purchaseCart(userID: string, cartItems: CartItem[]) {
    ...
    const allProductsAvailable = availabilityResults.every((availability) => availability);
    ...
    if (allProductsAvailable) {
      ...
      for (const cartItem of cartItems) {
        ...
        // TODO - ajouter call udpateProduct
        // 4 : créer une transaction pour chaque item
        // 3 : supprimer tous les items du panier
